"""
===============================================================================
Train CGAN with img, t, and cls as conditions
===============================================================================
"""
...
from configs.config_train_img_t_cls import cfg
...
if __name__ == '__main__':
    ...
    if cfg['use_model'] == 'wgangp':
        model = WGANGPModel_img_t_cls(dataModule.data_dims,cfg['g_e_net'],cfg['g_e_net_pretrained'],cfg['g_d_net'],cfg['g_d_net_pretrained'],cfg['dim_z'],cfg['dim_w'],cfg['dim_img'],cfg['dim_t'],cfg['num_cls'],cfg['z_fusion_type'],cfg['t_fusion_type'],cfg['data_time'],cfg['d_net'],cfg['d_net_pretrained'],cfg['d_transforms'],cfg['p_d_transforms'],cfg['lr'],cfg['losses_w'],cfg['final_actvn'])
    else:
    ...
    if cfg['use_model'] == 'wgangp':
        model = WGANGPModel_img_t_cls.load_from_checkpoint(ckpt_path)
