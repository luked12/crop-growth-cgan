...
'''
Config for train_img_t.py as dictionary 'cfg'.
...
# cfg['resume_train_exp_name'] = '20221130_174043_abd_wgangp_tf_0_dim_512_pe_add_img_256_z_16'
...
if cfg['data_name'] == 'abdc':
    cfg['img_dir'] = '../data/Arabidopsis/plantsort_434/'
    cfg['data_time'] = {'time_start': datetime.strptime('2015-11-23--12-00-00', '%Y-%m-%d--%H-%M-%S'),
                        'time_end': datetime.strptime('2016-01-01--12-00-00', '%Y-%m-%d--%H-%M-%S'),
                        'time_unit': 'd'}
    ...
    cfg['data_time'] = {'time_start': datetime.strptime('2021-06-15', '%Y-%m-%d'), 
...
use_model : str
    ...
    'gan': classic GAN (optimization: KL divergence)
    'wgangp': WGAN-GP
